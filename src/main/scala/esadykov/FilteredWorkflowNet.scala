 ...
 * @since 20.05.2014
 */
class FilteredWorkflowNet(source: NetNode, sink:NetNode, sockets: Set[NetNode], filterOut: Set[String])
    extends WorkflowNet(source, sink, sockets) {
